...
8. fight_stats mainly covers 2015+. Older fights may have no stats rows.
   When aggregating stats BY weight_class, always add HAVING COUNT(*) >= 20 to exclude
   obscure/historical classes (e.g. Super Heavyweight) with too few fights to be meaningful.
